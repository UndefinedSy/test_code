...
//
package main // import "stathat.com/c/consistent"
...
func (c *Consistent) updateSortedHashes() {
	...
	fmt.Printf("Before updateSortedHashes --- len=%d cap=%d circle_len=%d %v\n", len(c.sortedHashes), cap(c.sortedHashes), len(c.circle), hashes)
	...
	fmt.Printf("After updateSortedHashes --- len=%d cap=%d %v\n", len(hashes), cap(hashes), hashes)
}
